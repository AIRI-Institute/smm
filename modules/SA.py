...
from modules.object_discovery_encoder import Encoder
from modules.mixture_decoder import Decoder
...
class SlotAttention(nn.Module):
    def __init__(
        ...
        self.slot_mu = nn.Parameter(torch.zeros(1, self.num_slots, self.slot_size))
        self.slot_log_sigma = nn.Parameter(torch.zeros(1, self.num_slots, self.slot_size))
